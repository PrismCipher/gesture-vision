...
class FaceBlurApp(customtkinter.CTk):
    def __init__(self):
        ...
        self.is_experimental_enabled = False
        # creating widgets
        ...
        self.experimental_button = customtkinter.CTkButton(self.button_frame, text="experimental mode",
                                                       command=self.toggle_experimental)
        self.experimental_button.grid(row=0, column=4, padx=20, pady=15, sticky="ew")
    ...
    def toggle_experimental(self):
        ...
        if self.is_experimental_enabled:
            ...
            if self.is_debug_enabled:
                self.send_debug_message("experimental mode enabled")
        else:
            self.experimental_button.configure(fg_color="#1f538d", hover_color="#14375e")
            if self.is_debug_enabled:
                self.send_debug_message("experimental mode disabled")
